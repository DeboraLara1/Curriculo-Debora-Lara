    ...
    <>
      <Styled.Contaneir>
        <Styled.Pessoal>
          ...
          <Styled.DivCompetencias>
            Styled Components
            <Styled.Input background="linear-gradient(to right, #bebaba 75%, #ffffff 30%)" />
          </Styled.DivCompetencias>
          ...
          <Styled.DivCompetencias>
            Angular
            <Styled.Input background="linear-gradient(to right, #bebaba 80%, #ffffff 30%)" />
          </Styled.DivCompetencias>
          ...
          <Styled.DivCompetencias>
            ...
            <Styled.Input background="linear-gradient(to right, #bebaba 85%, #ffffff 30%)" />
          </Styled.DivCompetencias>

          <Styled.DivCompetencias>
            JQuery
            <Styled.Input background="linear-gradient(to right, #bebaba 40%, #ffffff 30%)" />
          </Styled.DivCompetencias>
          ...
          <Styled.DivCompetencias>
            Bootstrap
            <Styled.Input background="linear-gradient(to right, #bebaba 90%, #ffffff 30%)" />
          </Styled.DivCompetencias>

          <Styled.DivCompetencias>
            API REST
            <Styled.Input background="linear-gradient(to right, #bebaba 80%, #ffffff 60%)" />
          </Styled.DivCompetencias>

          <Styled.DivCompetencias>
            Figma
            <Styled.Input background="linear-gradient(to right, #bebaba 60%, #ffffff 30%)" />
          </Styled.DivCompetencias>

          <Styled.DivCompetencias>
            Design (Adobe XD) básico
            <Styled.Input background="linear-gradient(to right, #bebaba 30%, #ffffff 30%)" />
          </Styled.DivCompetencias>
          ...
          <Styled.DivCompetencias>
            Domínio de Lógica de Lirogramação
            <Styled.Input background="linear-gradient(to right, #bebaba 90%, #ffffff 30%)" />
          </Styled.DivCompetencias>

          <Styled.DivCompetencias>
            Git, GitHub, Gerrit, Jira, Kanban, Trello
            <Styled.Input background="linear-gradient(to right, #bebaba 80%, #ffffff 30%)" />
          </Styled.DivCompetencias>

          <Styled.DivCompetencias marginBottom>
            Windows e Linux intermediário
            <Styled.Input background="linear-gradient(to right, #bebaba 70%, #ffffff 30%)" />
          </Styled.DivCompetencias>
